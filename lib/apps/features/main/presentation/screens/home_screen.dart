  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              GestureDetector(
                onTap: () => context.push('/find-doctors'),
                child: Container(
              ...
              GridView.builder(
                ...
                itemBuilder: (context, index) =>
                    _DoctorCard(doctor: dummyDoctors[index]),
              ),
            ],
          ),
        ),
      ...
      bottomNavigationBar: BottomNavigationBar(
        onTap: (index) {
          if (index == 1) context.push('/favourites');
        },
          ...
          children: [
            ...
            Row(
              children: [
                ...
                Text(doctor.rating.toString(), style: AppTextStyles.hint),
              ],
            ),
          ],
        ),
